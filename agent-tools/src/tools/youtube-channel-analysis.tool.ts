...
export default class YouTubeChannelAnalysisTool extends ToolContext {
    ...
    async execute(input: { channelIdentifier: string; includeRecentVideos?: boolean; maxVideos?: number }) {
        try {
    ...
    private async resolveChannelId(identifier: string, apiKey: string): Promise<string> {
    ...
    private async searchChannelByUsername(username: string, apiKey: string): Promise<string> {
    ...
    private async getChannelDetails(channelId: string, apiKey: string) {
    ...
    private async getRecentVideos(channelId: string, maxResults: number, apiKey: string) {
    ...
    private calculateAnalytics(channelData: any, recentVideos: any[]) {
