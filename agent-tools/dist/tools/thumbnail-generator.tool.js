...
import { z } from 'zod';
let ThumbnailGeneratorTool = class ThumbnailGeneratorTool extends ToolContext {
    async execute(input) {
...
ThumbnailGeneratorTool = __decorate([
    Tool({
...
//# sourceMappingURL=thumbnail-generator.tool.js.map